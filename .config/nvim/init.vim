...
" TODO: I think this is handled by vim-unimpaired
...
" TODO: Below are related settings that I'm not sure about.
" use tabs
imap <expr><TAB>
...
" imap {{ {<CR>}<Esc>O
" trial using ctr-s & ctr-s-s and vim-surround which seems more advanced
...
" open alternatives (projectionist)
